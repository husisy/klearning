# https://github.com/Trigolds/TaichiX/blob/master/Thermal2D/Thermal2D_FDM_MGPCG.py
import numpy as np
import time
import taichi as ti
...
dt = 5.0
K = 5.0
pixels = ti.Vector.field(3, dtype=ti.f32, shape=(nb_node_1D, nb_node_1D))
pixels.fill(0)
...
class MGPCG_Jacobi_V:
    def __init__(self):
        ...
        self.e = ti.field(ti.f32, shape=shape)
        self.x = ti.field(ti.f32, shape=shape)
        self.res = ti.field(ti.f32, shape=shape)
        self.b = ti.field(ti.f32, shape=shape)
